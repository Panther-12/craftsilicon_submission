...
const MatchCountdown: React.FC = () => {
  // Set a target date for the countdown (for example, the next match date)
  const targetDate = new Date("2024-12-25T01:00:00"); // Change this to the actual match date and time
